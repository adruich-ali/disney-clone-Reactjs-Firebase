...
import Watchlist from "../imgs/watchlist-icon.svg";
import Originals from "../imgs/original-icon.svg";
import Movies from "../imgs/movie-icon.svg";
import Series from "../imgs/series-icon.svg";
